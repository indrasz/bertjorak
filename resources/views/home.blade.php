...
<head>
    ...
    <title>Bertjorak</title>
    <link rel="stylesheet" href="{{ asset('/frontend/vendor/css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('/frontend/style/landing.css') }}">

    <link rel="stylesheet" href="{{ url('https://unpkg.com/flickity@2/dist/flickity.min.css') }}">


    <!-- Owl Carousel -->
    <link rel="stylesheet" href="{{ url('https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/assets/owl.carousel.min.css') }}" />
    <link rel="stylesheet" href="{{ url('https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/assets/owl.theme.default.min.css') }}"
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class=" flex-lg-row flex-column d-flex w-100 align-items-lg-center align-items-baseline">
                        ...
                        <div class="mt-3 flex-lg-row flex-column d-flex mt-lg-0 navbar-buttons">
                            <a href="#" class="btn btn-login mx-3">Login</a>
                            <a href="#" class="btn btn-register mx-3">Register</a>
                        </div>
                    </div>
                </div>
            </div>
