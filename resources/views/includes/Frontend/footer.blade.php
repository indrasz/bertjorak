    ...
    <footer class="footer-3-2 h-100" style="font-family: 'Poppins', sans-serif">
        <div class="container-xxxl mx-auto main">
            <div class="d-flex flex-lg-row flex-column" style="margin-bottom: 5rem">
                <div class="left-col">
                    <a href="/">
                        <img class="py-10" src="{{ asset('frontend/images/main-logo.png') }}" alt="main-logo"
                            width="75" />
                    </a>
                ...
                <div class="right-col">
                    <style>
                        div.right-col div.d-flex.row.gap {
                            padding-left: 20px;
                        }
                        ...
                        div.form-control-wrapper input:focus {
                            outline: none;
                        }

                        div.form-control-wrapper button {
                        ...
                        div.form-control-wrapper button:hover {
                            transition: 0.5s ease;
                    ...
                    <div class="d-flex gap-lg-0 gap-2" style="flex-direction: column; ">
                        ...
                        <div class="d-flex footer-icon align-items-start mb-md-0 gap-3">
                            <a href="https://www.linkedin.com/company/bertjorak/" target="_blank">
                                <svg class="icon-fill" width="28" height="28" viewBox="0 0 20 20" fill="none"
                            ...
                            <a href="https://vt.tiktok.com/ZSdW8JTew/" target="_blank">
                                <svg class="icon-fill" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                    width="28" height="28" viewBox="0 0 50 50" style=" fill:#undefined;">
                                    <path
                            ...
                            <a href="https://www.instagram.com/bertjorak" target="_blank">
                                <svg class="icon-stroke" width="28" height="28" viewBox="0 0 20 20"
            ...
            <div class="container-xxxl p-0 mx-auto d-flex flex-column-reverse flex-lg-row justify-content-center align-items-center gap-lg-0 gap-3"
                ...
                <nav class="text-lg-start text-white text-center credit-font">
                    @php
                        $year = date('Y');
                    @endphp
                    <p class="text-small pt-4 pb-4 mb-0">© {{ $year }} with Bertjorak. All rights reserved.</p>
                </nav>
            </div>
        </div>
    </footer>
