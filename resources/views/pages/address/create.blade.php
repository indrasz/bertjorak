                                ...
                                <div class="px-4 py-5 sm:p-6">
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="col-span-6">
                                            <label for="title" class="block mb-3 font-medium text-gray-700 text-md">Jenis
                                                Alamat</label>

                                            <input placeholder=" Kos / Kontrakan / Kantor / Rumah" type="text" name="name"
                                        ...
                                        <div class="col-span-6">
                                            <label for="title"
                                                class="block mb-3 font-medium text-gray-700 text-md">Provinsi</label>

                                            <select name="provinsi" id="provinsi"
                                                class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm"
                                                value="{{ old('name') }}">
                                                @foreach ($ongkir as $o)
                                                    <option value="1">{{ $o['province'] }}</option>
                                                @endforeach
                                            </select>
