                    ...
                    <div class="p-10 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-5">
                        ...
                        @foreach ($article as $a)
                            <div class="rounded overflow-hidden shadow-lg bg-white">
                                ...
                                <img class="object-scale-down h-40 w-full"
                                    src="{{ asset('/storage/articles/images/' . $getImage) }}" alt="Image">
                                <div class="px-6 py-4">
                                    {{-- Logo Header --}}
                                    @if ($a->logo_header != null)
                                        <a href="{{ route('dashboard.article.show', $a->id) }}">
                                            <img class="w-24 mb-2"
                                                src="{{ asset('/storage/articles/logo/' . json_decode($a->logo_header, true)) }}"
                                                alt="Logo Header">
                                        </a>
                                    @endif
