        ...
        <section class="container px-6 py-4 mx-auto mt-5">
            @foreach ($articles as $at)
                <div class="bg-white rounded-lg overflow-hidden shadow-lg">
                    <img class="w-full"
                        src="{{ asset('/storage/articles/images/' . json_decode($at->image, true)) }}" alt="Image">
                    <div class="px-6 py-4">
                        {{-- Title Header --}}
                        ...
                        @if ($at->logo_header != null)
                            <img class="w-24 mb-2"
                                src="{{ asset('/storage/articles/logo/' . json_decode($at->logo_header, true)) }}"
                                alt="Logo Header">
                        @endif
