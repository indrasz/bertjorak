                                ...
                                <div class="px-4 py-5 sm:p-6">
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="col-span-6">
                                            <label for="title" class="block mb-3 font-medium text-gray-700 text-md">Nama Produk</label>

                                            <input placeholder="Nama Produk yang ingin ditambahkan" type="text" name="name" id="name" autocomplete="name" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="{{ old('name') }}" required>
                                        ...
                                        <div class="col-span-6">
                                            <label for="price" class="block mb-3 font-medium text-gray-700 text-md">Harga Produk</label>

                                            <input placeholder="Total Harga Produk " type="number" name="price" id="price" autocomplete="price" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="{{ old('price') }}" required>
                                        ...
                                        <div class="col-span-6">
                                            <label for="thumbnail-service" class="block mb-3 font-medium text-gray-700 text-md">Thumbnail Product Feeds</label>
                                        ...
                                        <div class="col-span-6">
                                            <label for="orderDay" class="block mb-3 font-medium text-gray-700 text-md">Jumlah Stok</label>
                                         ...
                                         <div class="col-span-6">
                                            <label for="size" class="block mb-3 font-medium text-gray-700 text-md">Size Produk</label>

                                            <input placeholder="size" type="text" name="size[]" id="size" autocomplete="size" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="{{ old('size[]') }}" required>
...
@push('after-script')
    ...
    <script type="text/javascript">
        ...
        $("#addAdvantagesRow").click(function() {
            var html = '';
            html += '<input placeholder="size" type="text" name="size[]" id="size" autocomplete="size" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" required>';
