                        ...
                        <section class="pt-6 pb-20 mx-8 w-auth">
                            <div class="grid gap-5 md:grid-cols-12">
                                <main class="p-lg-4 p-1 lg:col-span-7 md:col-span-12">
                                    <span class="inline-flex items-center justify-center px-3 py-2 mb-4 mr-2 text-xs leading-none text-green-500 rounded-full bg-serv-green-badge">Success</span>
                                    ...
                                    <div class="content">
                                        <div>
                                            ...
                                            <div class="leading-8 text-md">
                                                <h2 class="text-xl font-semibold">About This <span class="text-serv-button">Product</span></h2>
