                            ...
                            <td class="px-1 py-5 text-sm w-2/8">
                                    <div class="flex items-center text-sm">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm text-gray-400">Full - Stack Develo per</p>
                                        </div>
                                    </div>
                                </td>
                                <td class="w-2/6 px-1 py-5">
                                ...
                                <td class="px-1 py-5 text-sm">
                                    <a href="{{ route('dashboard.transaction.edit') }}" class="px-4 py-2 mt-2 text-left text-white rounded-xl bg-serv-email">
                                        Details
                                    </a>
                                </td>
                            </tr>
